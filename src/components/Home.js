...
<div className="row" id="Body">
    <div className="inner-row">
        ...
        <form onSubmit={this.feedUpdate} method="post" id='feed-box'>
            <input id='userFeed' name="userFeed" onChange={this.onChange} value={this.state.userFeed} type="text" placeholder="Share something..."/>
            <button id='btn-feed' type="submit" value="Post" className="submit-btn" onClick={this.feedUpdate}>Post</button>
        </form>
       
    
          <p> Pictures of your friends </p>
          <ImageSlider />
